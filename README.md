...
For this project Node, and yarn will need to be installed first 

https://nodejs.org/en/download/

https://yarnpkg.com/en/

Yarn was used to manage this code so please use yarn instead of npm 
