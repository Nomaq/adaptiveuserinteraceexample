                    ...
                    <thead>
                        <tr>
                            ...
                            <th style={{
                                                                    color: this.props.currentUI.ColorPallete.firstColor,
                                                                    fontSize: this.props.currentUI.Font.headingFS,
                                                                    fontWeight: this.props.currentUI.Font.headingFW }} className="th-description">Currency</th>
                            <th style={{
                                                                    color: this.props.currentUI.ColorPallete.firstColor,
                                                                    fontSize: this.props.currentUI.Font.headingFS,
                            ...
                            <th style={{
                                                                    color: this.props.currentUI.ColorPallete.firstColor,
                                                                    fontSize: this.props.currentUI.Font.headingFS,
                                                                    fontWeight: this.props.currentUI.Font.headingFW }} className="text-right">Queued</th>
                            <th style={{
                                                                    color: this.props.currentUI.ColorPallete.firstColor,
                                                                    fontSize: this.props.currentUI.Font.headingFS,
                    ...
                    <tbody>
                        <tr>
                            <td className="td-name">
                                <a style={{   color: this.props.currentUI.ColorPallete.secondColor,
                            ...
                            <td style={{   color: this.props.currentUI.ColorPallete.secondColor,
                                           fontSize: this.props.currentUI.Font.textFS,
